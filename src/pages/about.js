    ...
    return (
        <div id="om" className="w-screen h-screen z-10 flex flex-col justify-center mt-10 items-center">
            ...
            <div className="md:w-1/2 space-y-20"> 
                    <div className="container p-2 md:p-0 flex flex-row items-center"><h2 className="text-4xl font-ivyora font-light tracking-widest">Om Natasja</h2>                     <div>
                    <a className="cursor-pointer">
                    <svg  className="mt-2 ml-2"  width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h2 className="text-2xl font-light font-ivyora tracking-widest">Kort fortalt</h2>
                    ...
                    <h2 className="text-2xl font-light font-ivyora tracking-widest">Færdigheder</h2>
